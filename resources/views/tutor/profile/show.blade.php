    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <!-- Left Side: Profile Photo & Key Info Card -->
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden p-6 space-y-6 self-start text-center">
                    <div class="flex flex-col items-center space-y-4">
                        <!-- Profile Image Container -->
                        @if ($profile->profile_photo)
                            <img src="{{ Storage::url($profile->profile_photo) }}" alt="Tutor Photo" class="w-36 h-36 rounded-full object-cover shadow-md border-4 border-slate-50">
                        @else
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500 font-medium">Professional Tutor</p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 lg:col-span-2 space-y-8">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start space-x-3 bg-slate-50 p-4 rounded-xl border border-slate-100 text-sm">
                            ...
                            <div>
                                <h4 class="font-bold text-slate-800">Institutions & Qualifications</h4>
                    ...
                    <!-- Experience Section -->
                    <div class="space-y-3">
                        <h3 class="text-lg font-bold text-slate-800 border-b border-slate-100 pb-2">Teaching Experience</h3>
                        <div class="flex items-start space-x-3 bg-slate-50 p-4 rounded-xl border border-slate-100 text-sm">
                            <div class="p-2 rounded-lg bg-violet-50 text-violet-600 mt-0.5">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                            </div>
                            <div>
                                <h4 class="font-bold text-slate-800">Background & Industry History</h4>
