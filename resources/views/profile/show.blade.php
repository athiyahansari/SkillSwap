                ...
                <div class="mb-6">
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">Manage your name, email, and profile photo.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-10 sm:mt-0">
                <div class="flex items-center space-x-3 mb-4 mt-8">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">Keep your account safe with passwords, 2FA, and session management.</p>
                    </div>
                </div>
            </div>
