            ...
            <div class="bg-white/75 backdrop-blur-xl rounded-[32px] w-full max-w-md p-8 border border-white/50 shadow-2xl shadow-indigo-950/15">
                <div class="space-y-6">
                    ...
                    <div class="space-y-3 text-left">
                        ...
                        <div>
                            <h3 class="text-2xl font-extrabold text-slate-800 font-['Outfit']">Reset Your Password</h3>
                            <p class="text-xs text-slate-400 font-medium mt-1.5">No worries! Enter your email and we'll send you a reset link.</p>
                        </div>
                    </div>
                    ...
                    <!-- Form -->
                    <form method="POST" action="{{ route('password.email') }}" class="space-y-4" @submit="loading = true">
                        @csrf
