    ...
    <div class="py-12 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <!-- Total Learning Spent -->
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div class="p-3 rounded-xl bg-amber-50 text-amber-600">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 8h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V15a2 2 0 01-2 2z"></path></svg>
                        </div>
                        <span class="text-xs font-semibold text-amber-600 bg-amber-50 px-2.5 py-0.5 rounded-full">All-time</span>
                    </div>
                    <div class="mt-4">
                        <h3 class="text-2xl font-bold text-slate-800">${{ number_format($totalSpent, 2) }}</h3>
                        <p class="text-sm font-medium text-slate-500 mt-1">Total Learning Spent</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div class="flex items-center justify-between sm:justify-end gap-6">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        @elseif ($booking->status === 'pending')
                                            ...
                                            <form action="{{ route('learner.bookings.cancel', $booking) }}" method="POST" class="inline" data-confirm="Are you sure you want to cancel this booking?">
                                                @csrf
                                                @method('PUT')
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <a href="{{ route('inbox.index') }}" class="flex items-center p-3 rounded-xl hover:bg-slate-50 border border-slate-100 transition-colors group">
